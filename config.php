<?php
	...
	*/
	...
	$config['client_download'] = 'http://creativetibia.com';
	$config['client_download_linux'] = 'http://creativetibia.com';
	...
	$config['gameserver'] = array(
		...
		'port' => 7172,
		'name' => 'Creative' // Must be identical to config.lua (OT config file) server name.
	);
